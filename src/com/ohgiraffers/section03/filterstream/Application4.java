...
public class Application4 {
    ...
    public static void main(String[] args) {
        ...
        MemberDTO[] outputMembers = {
                new MemberDTO("user01", "pass01", "홍길동", "hong777@ohgiraffers", 25, '남', 1250.7),
                new MemberDTO("user02", "pass02", "유관순", "korea31@ohgiraffers", 16, '여', 1221.6),
                new MemberDTO("user03", "pass03", "이순신", "lee123@ohgiraffers", 22, '남', 1234.6),
        };
        ...
        /* DTO 클래스에 직렬화 처리를 하지 않았다면 실행시 NotSerializableException이 발생한다.
        * 직렬화란?
